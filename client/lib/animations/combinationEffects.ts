...
export function createParticleEchoCombo(config: AnimationConfig) {
  ...
  const primaryColor = POKEMON_TYPE_COLORS[primaryType as PokemonTypeName] || '#68A090';
  ...
  const particles = TYPE_EFFECTS[primaryType as keyof typeof TYPE_EFFECTS] || TYPE_EFFECTS.normal;
